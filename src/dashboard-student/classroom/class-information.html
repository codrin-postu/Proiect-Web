...
<head>
    ...
    <title>ClassMan Student | Class Information</title>
</head>
...
<body class="stop-transition-load" id="body-padding">
                ...
                <div class="nav-list">
                    ...
                    <div class="nav-class">
                        ...
                        <div class="class-links">
                            <a href="./class-information.html" class="nav-link active">
                                <i class="fas fa-book-open"></i>
                                <span class="nav-name">Class Information</span>
                            </a>
                            <a href="./check-attendance.html" class="nav-link">
    ...
    <!-- Dashboard Content  -->
    <div class="main-content information-section">

        <section class="class-banner">
            <h2>Web Technologies</h2>
            <p>An Introduction to Web Development</p>
        </section>
            ...
            <div class="section-content">
                <table>
                    ...
                    <tr>
                        ...
                        <td>HTML, CSS, JavaScript, PHP, Front End, Back End</td>
                    </tr>
                    </tr>
                </table>
