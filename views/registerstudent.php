...
<head>
    ...
    <title>Register | Create a Student account</title>
</head>
...
<body>
    <div class="loginbox register">
        ...
        <form action="/nothing.js" target="blank">
            ...
            <input type="password" name="Password" placeholder="Enter password again" required pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,}$" required>
